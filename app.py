...
# Fallback model list - try in order until one works
OPENROUTER_MODELS = [
...
**AI Engine**: Auto-fallback free models via OpenRouter  
**Models (tried in order)**: Qwen 2.5 72B → Llama 3.1 8B → Qwen 2 7B → Gemma 2 9B  
